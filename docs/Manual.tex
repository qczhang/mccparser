...
\begin{grammarrule}{statement}{\terminal{sequence} \terminal{(} \token{IDENT}
  ...
  \altrule{\terminal{explore} \terminal{(} \nonterminal{fgRef}
    \nonterminal{model filter}? \nonterminal{outputform}? \terminal{)}}
  \altrule{\terminal{exploreLV} \terminal{(} \nonterminal{fgRef}
    \nonterminal{model filter}? \nonterminal{outputform}?
    \nonterminal{time limit}? \nonterminal{backtrack size}? \terminal{)}}
...
\end{grammarrule}
\begin{grammarrule}{model filter}{\terminal{rmsd} \terminal{(} \token{INTEGER}
    \terminal{align}? \nonterminal{atomset}? \terminal{no\_\,hydrogen}? 
    \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{outputform}{\terminal{file\_pdb} \terminal{(}
    \token{STRING} \terminal{zipped}? \terminal{)}}
  \altrule{\terminal{file\_bin} \terminal{(} \token{STRING}
    \terminal{zipped}? \terminal{)}}
  \altrule{\terminal{socket\_bin} \terminal{(} \token{STRING}
    \token{INTEGER} \token{STRING} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{time limit}{\terminal{time\_\,limit} \terminal{(}
    \nonterminal{timelimit}+ \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{timelimit}{\token{INTEGER} \terminal{seconds}}
  \altrule{\token{INTEGER} \terminal{sec}}
  \altrule{\token{FLOAT} \terminal{minutes}}
  \altrule{\token{FLOAT} \terminal{min}}
  \altrule{\token{FLOAT} \terminal{hours}}
  \altrule{\token{FLOAT} \terminal{hr}}
  \altrule{\token{FLOAT} \terminal{days}}
  \altrule{\token{FLOAT} \terminal{d}}  
\end{grammarrule}
\begin{grammarrule}{backtrack size}{\terminal{backtrack\_\,size} \terminal{(}
    \token{INTEGER} \token{INTEGER} \terminal{)}}
\end{grammarrule}
...
\begin{grammarrule}{fgexp}{\terminal{backtrack} \terminal{(} \nonterminal{fgRef}?
  ...
  \altrule{\terminal{cache} \terminal{(} \nonterminal{fgRef}
    \nonterminal{model filter} \terminal{)}}
  \altrule{\terminal{library} \terminal{(} \nonterminal{inputform}
    \nonterminal{libopt}* \terminal{)}}
  \altrule{\terminal{moses} \terminal{(} \nonterminal{resrange}? \nonterminal{ctfileid}?
    \nonterminal{mosesqueries} \nonterminal{mfold\_epc}? \nonterminal{mfold\_win}?
    \nonterminal{mfold\_output}? \terminal{)}}
\end{grammarrule}
...
\end{grammarrule}
\begin{grammarrule}{inputform}{\terminal{file\_pdb} \terminal{(}
    \token{STRING} \terminal{)}}
  \altrule{\terminal{file\_bin} \terminal{(} \token{STRING} \terminal{)}}
  \altrule{\terminal{socket\_bin} \terminal{(} \token{STRING}
    \token{INTEGER} \token{STRING} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{libopt}{\terminal{strip} \terminal{(}
  ...
  \altrule{\terminal{change\_\,id} \terminal{(} \token{STRING} \terminal{,}
    \token{STRING} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{resrange}{\token{RESNAME} \terminal{-} \token{RESNAME}}
  \altrule{\token{INTEGER} \terminal{-} \token{INTEGER}}
\end{grammarrule}
\begin{grammarrule}{ctfileid}{\terminal{sec\_struct} \terminal{(}
    \token{INTEGER} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{mosesqueries}{\terminal{cgau\_resdef}? \terminal{gu\_resdef}?
    \terminal{loop\_resdef}? \terminal{stem\_condef}? \terminal{loop\_condef}? 
    \terminal{cgau\_pairdef}? \terminal{gu\_pairdef}?} 
\end{grammarrule}
\begin{grammarrule}{cgau\_resdef}{\terminal{stem\_cg\_au\_residue} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{gu\_resdef}{\terminal{stem\_gu\_residue} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{loop\_resdef}{\terminal{loop\_residue} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{stem\_condef}{\terminal{stem\_connect} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{loop\_condef}{\terminal{loop\_connect} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{cgau\_pairdef}{\terminal{stem\_cg\_au\_pair} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{gu\_pairdef}{\terminal{stem\_gu\_pair} \nonterminal{queryexp}
    \nonterminal{sampling}}
\end{grammarrule}
\begin{grammarrule}{mfold\_epc}{\terminal{mfold\_epc} \terminal{(}
    \token{INTEGER} \terminal{\%} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{mfold\_win}{\terminal{mfold\_win} \terminal{(}
    \token{INTEGER} \terminal{)}}
\end{grammarrule}
\begin{grammarrule}{mfold\_output}{\terminal{mfold\_output} \terminal{(}
    \token{STRING} \terminal{)}}
\end{grammarrule}
